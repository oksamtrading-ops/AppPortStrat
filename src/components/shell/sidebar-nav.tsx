...
function navItems(engagementId: string): NavItem[] {
  ...
  return [
    ...
    { href: `${base}/responses`, label: "Responses", icon: Table2, roles: ["ENGAGEMENT_LEAD", "CONSULTANT"] },
    ...
    { href: `${base}/tasks`, label: "Tasks", icon: SquareCheckBig, roles: ["ENGAGEMENT_LEAD", "CONSULTANT"] },
    { href: `${base}/activity`, label: "Activity", icon: Activity, roles: ["ENGAGEMENT_LEAD", "CONSULTANT"] },
