...
const RELATION_MAP: Record<string, Record<string, string>> = {
  ...
  Membership: { engagement: "Engagement", assignments: "SurveyAssignment", authoredComments: "Comment", notifications: "Notification", assignedTasks: "Task", createdTasks: "Task", signOffs: "DispositionSignOff", respondentResponses: "SurveyResponse" },
  ...
  Application: { engagement: "Engagement", assignments: "SurveyAssignment", responses: "SurveyResponse", result: "DispositionResult", override: "DispositionOverride", costRecords: "CostRecord", commentThreads: "Comment", tasks: "Task", signOff: "DispositionSignOff" },
  CapabilityNode: { engagement: "Engagement", parent: "CapabilityNode", children: "CapabilityNode", commentThreads: "Comment" },
  SurveyAssignment: { engagement: "Engagement", application: "Application", template: "SurveyTemplate", membership: "Membership" },
  SurveyResponse: { engagement: "Engagement", application: "Application", template: "SurveyTemplate", answers: "Answer", respondent: "Membership" },
  ...
  Comment: { engagement: "Engagement", application: "Application", capabilityNode: "CapabilityNode", author: "Membership", parent: "Comment", replies: "Comment" },
  Notification: { engagement: "Engagement", recipient: "Membership" },
  DispositionSignOff: { engagement: "Engagement", application: "Application", signedBy: "Membership" },
